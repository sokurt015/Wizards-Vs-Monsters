...
public class ModeSlide : MonoBehaviour
{
    public RectTransform currentPanel; // visible at start
    public RectTransform nextPanel;    // starts offscreen right
    ...
    public void SlideForward()
    {
        ...
        StartCoroutine(SlidePanels(
            from: currentPanel,
            fromEnd: new Vector2(screenWidth, 0),           // current → right
            to: nextPanel,
            toStart: new Vector2(-screenWidth, 0),          // next starts left
            toEnd: Vector2.zero,
            onComplete: () =>
            {
    ...
    public void SlideBackward()
    {
        ...
        StartCoroutine(SlidePanels(
            from: currentPanel,
            fromEnd: new Vector2(-screenWidth, 0),           // current → left
            to: previousPanel,
            toStart: new Vector2(screenWidth, 0),            // previous starts right
            toEnd: Vector2.zero,
            onComplete: () =>
            {
